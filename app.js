...
// let songName = "MyFavoriteSong.mp3"; // Define the song name

// // Add a click listener to the download link
// document.getElementById('download_music').addEventListener('click', function (e) {
//     e.preventDefault(); // Prevent default link action
//     if (!songName) {
//         console.error("songName is not defined or invalid");
//         return;
//     }
//     // Create a download link dynamically
//     const downloadLink = document.createElement('a');
//     downloadLink.href = songName; // Set the file path
//     downloadLink.download = songName.split('/').pop(); // Extract file name
